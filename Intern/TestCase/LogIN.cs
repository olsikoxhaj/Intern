...
namespace Intern.TestCase
{
    public class LogIn : SetUp
    {
        ...
        public void TestLoginAddToCart()
        {
            ...
            //te shtosh kusht kontrolli nese tka dal texti mesazhi i suksesit

            IWebElement successMessage = driver.FindElement(By.XPath("//div[@class='alert alert-success alert-dismissible']"));
            string actualSuccessText = successMessage.Text;
